 ...
 *
 */
#ifndef gxos_ATCMDPARSER_H
#define gxos_ATCMDPARSER_H
...
public:
     ...
     * @param timeout timeout of the connection
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.5.0", "Replaced with set_timeout for consistency")
     ...
     * @param output_delimiter string of characters to use as line delimiters
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.5.0", "Replaced with set_delimiter for consistency")
     ...
     * @param on set as 1 to turn on traces and vice versa.
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.5.0", "Replaced with debug_on for consistency")
     ...
     */
    bool send(const char *command, ...) gxos_PRINTF_METHOD(1,2);
     ...
     */
    bool recv(const char *response, ...) gxos_SCANF_METHOD(1,2);
     ...
     * @return number of bytes written or -1 on failure
     */
    int printf(const char *format, ...) gxos_PRINTF_METHOD(1,2);
     ...
     * @return number of bytes read or -1 on failure
     */
    int scanf(const char *format, ...) gxos_SCANF_METHOD(1,2);
     ...
     */
    void oob(const char *prefix, gxos::Callback<void()> func);
