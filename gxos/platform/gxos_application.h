 ...
 */
#ifndef gxos_APPLICATION_H
#define gxos_APPLICATION_H

#include<stdint.h>

#define gxos_APPLICATION_SUPPORT defined(__CORTEX_M3) || defined(__CORTEX_M4) || defined(__CORTEX_M7)
#if gxos_APPLICATION_SUPPORT
#ifdef __cplusplus
extern "C" {
#endif
 ...
 */
void gxos_start_application(uintptr_t address);
