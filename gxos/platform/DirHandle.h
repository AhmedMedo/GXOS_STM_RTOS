 ...
 */
#ifndef gxos_DIRHANDLE_H
#define gxos_DIRHANDLE_H
...
public:
     ...
     *   -1 on error.
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4", "Replaced by DirHandle::close")
     ...
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4", "Replaced by DirHandle::read")
     ...
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4", "Replaced by DirHandle::rewind")
     ...
     *  -1 on error.
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4", "Replaced by DirHandle::tell")
     ...
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4", "Replaced by DirHandle::seek")
