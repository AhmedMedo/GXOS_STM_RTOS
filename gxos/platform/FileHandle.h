 ...
 */
#ifndef gxos_FILEHANDLE_H
#define gxos_FILEHANDLE_H
...
public:
     ...
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4", "Replaced by FileHandle::seek")
     ...
     *   -1 on error
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4", "Replaced by FileHandle::sync")
    virtual int fsync()
    {
        return sync();
    }
     ...
     *   Length of the file
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4", "Replaced by FileHandle::size")
    virtual off_t flen()
    {
        return size();
    }
