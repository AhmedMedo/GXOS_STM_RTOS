 ...
 */
#ifndef gxos_LOCALFILESYSTEM_H
#define gxos_LOCALFILESYSTEM_H
...
/** A filesystem for accessing the local gxos Microcontroller USB disk drive
 *
 *  This allows programs to read and write files on the same disk drive that is used to program the
 *  gxos Microcontroller. Once created, the standard C file access functions are used to open,
 ...
 *  not exit, you will need to hold down reset on the gxos Microcontroller to be able to see the drive again!
 * @ingroup platform
 */
