 ...
 *
 *  @param stats    A pointer to the gxos_stats_heap_t structure to fill
 */
void gxos_stats_heap_get(gxos_stats_heap_t *stats);
 ...
 *
 *  @param stats    A pointer to the gxos_stats_stack_t structure to fill
 */
void gxos_stats_stack_get(gxos_stats_stack_t *stats);

/**
 *  Fill the passed array of stat structures with the stack stats
 *  for each available stack.
 *
 *  @param stats    A pointer to an array of gxos_stats_stack_t structures to fill
 *  @param count    The number of gxos_stats_stack_t structures in the provided array
 *  @return         The number of gxos_stats_stack_t structures that have been filled,
 *                  this is equal to the number of stacks on the system.
 */
size_t gxos_stats_stack_get_each(gxos_stats_stack_t *stats, size_t count);
