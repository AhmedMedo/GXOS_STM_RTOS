 ...
 */
#ifndef gxos_CALLBACK_H
#define gxos_CALLBACK_H
...
#define gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, M)                            \
...
public:
     ...
     */
    template <typename F>
    Callback(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)())) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)() const)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)() volatile)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)() const volatile)) {
        generate(f);
    }
     ...
     */
    template<typename T, typename U>
    gxos_DEPRECATED_SINCE("gxos-os-5.1",
        "Arguments to callback have been reordered to Callback(func, arg)")
     ...
     */
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(R (*func)()) {
        this->~Callback();
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)())) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)() const)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)() volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)() const volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
...
private:
    ...
    void generate(const F &f) {
        ...
        gxos_STATIC_ASSERT(sizeof(Callback) - sizeof(_ops) >= sizeof(F),
...
public:
     ...
     */
    template <typename F>
    Callback(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0))) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0) const)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0) volatile)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0) const volatile)) {
        generate(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0))) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0) const)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0) volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0) const volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
...
public:
     ...
     */
    template <typename F>
    Callback(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1))) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1) const)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1) volatile)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1) const volatile)) {
        generate(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1))) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1) const)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1) volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1) const volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
...
public:
     ...
     */
    template <typename F>
    Callback(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2))) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2) const)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2) volatile)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2) const volatile)) {
        generate(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2))) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2) const)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2) volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2) const volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
...
public:
     ...
     */
    template <typename F>
    Callback(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3))) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3) const)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3) volatile)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3) const volatile)) {
        generate(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3))) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3) const)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3) volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3) const volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
...
public:
     ...
     */
    template <typename F>
    Callback(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3, A4))) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3, A4) const)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3, A4) volatile)) {
        generate(f);
    }
     ...
     */
    template <typename F>
    Callback(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3, A4) const volatile)) {
        generate(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3, A4))) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3, A4) const)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3, A4) volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
    ...
    gxos_DEPRECATED_SINCE("gxos-os-5.4",
        "Replaced by simple assignment 'Callback cb = func")
    void attach(const volatile F f, gxos_ENABLE_IF_CALLBACK_COMPATIBLE(F, R (F::*)(A0, A1, A2, A3, A4) const volatile)) {
        this->~Callback();
        new (this) Callback(f);
    }
