...
#ifndef gxos_UARTSERIAL_H
#define gxos_UARTSERIAL_H
...
#ifndef gxos_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE
#define gxos_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE  256
#endif

#ifndef gxos_CONF_DRIVERS_UART_SERIAL_TXBUF_SIZE
#define gxos_CONF_DRIVERS_UART_SERIAL_TXBUF_SIZE  256
#endif
...
public:
     ...
     *  @param baud The baud rate of the serial port (optional, defaults to gxos_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE)
     */
    UARTSerial(PinName tx, PinName rx, int baud = gxos_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE);
    virtual ~UARTSerial();
...
private:
     ...
     *  By default buffer size is 256 for TX and 256 for RX. Configurable through gxos_app.json
     */
    CircularBuffer<char, gxos_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE> _rxbuf;
    CircularBuffer<char, gxos_CONF_DRIVERS_UART_SERIAL_TXBUF_SIZE> _txbuf;
