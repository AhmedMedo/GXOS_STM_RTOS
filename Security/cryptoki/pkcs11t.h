...
//typedef struct CK_RSA_PKCS_PARAMS {
//	CK_BYTE_PTR pmodulus;
//	CK_BYTE_PTR pPublicExponent;
//	CK_BYTE_PTR pPrivateExponent;
//} CK_RSA_PKCS_PARAMS;

//typedef CK_RSA_PKCS_PARAMS *   CK_RSA_PKCS_PARAMS_PTR;
 ...
 * object  */
typedef CK_BYTE          CK_OBJECT_HANDLE;
...
typedef struct CK_MECHANISM {
  ...
  CK_BYTE_PTR       pParameter;

  /* ulParameterLen was changed from CK_USHORT to CK_ULONG for
   * v2.0 */
  CK_ULONG          ulParameterLen;  /* in bytes */
//  CK_RSA_PKCS_PARAMS_PTR Rsa_object;
} CK_MECHANISM;
